...
| **Financier** | Combien cela a coûté, rapporté, encaissé ? Reste à recevoir ? Marge ? Perte financière ? | `sales.sales`, `finance.customer_payments`, `finance.payment_allocations`, `finance.expenses`, `finance.supplier_invoices`, `finance.supplier_payments`, `finance.cash_movements` (registre de caisse), `finance.cost_entries` (registre de coûts), coût unitaire figé sur chaque `stock_move` | Créances, dettes fournisseurs, soldes de caisse, marges, valorisation du stock |
