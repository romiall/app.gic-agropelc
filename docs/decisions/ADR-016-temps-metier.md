...
- Stockage `DATETIME(6)` en UTC, toujours écrit et lu par le convertisseur unique de `packages/domain` (MySQL n'a pas de type conscient du fuseau, ADR-023) ; serveur synchronisé par NTP.
